...
```
=== Операции над представлениями и композиция
TODO - написать мотивацию и что я имел тут ввиду

// Я понимаю юзкейс, но я не могу сформулировать имя для задачи
Данная задача возникает в библиотеках сериализации, библиотеках работы с базами данных, RPC и т.д. Предоставление некого фреймворка, работы с даннымы на уровне языка/стандартной библиотеки предоставит возможность для бесшовной интеграции между моделями данных различныx библиотек, использующими этот фреймворк.
