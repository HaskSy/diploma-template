...
#definition("Copy On Write") [ #TODO[Много где] ]
#definition("Композируемость") [ #TODO[Много где] ]
#definition("Объект первого класса") [ #TODO[Много где] ]
#definition("Доменная модель") [ #TODO[ Уже забыл где] ]
#definition("Higher-kinded полиморфизм") [ #TODO[профунктор оптика и лаарховен] ]
...
#definition("Тип-запись") [ #TODO[`getter`/`setter` модель ] ]
#definition("Инлайнинг") [ #TODO[Да много где] ]
#definition("Замыкание") [ #TODO[Да много где] ]
#definition("ad-hoc полиморфизм") [ #TODO[Классы типов и Van Laarhoevn] ]
#definition("Класс типов + перегрузка") [ #TODO[Классы типов и Van Laarhoevn] ]
#definition("let-полиморфизм") [ #TODO[Андрей yпомянул в аннотациях] ]
#definition("Алгебраический тип данный (ADT)") [ #TODO[Van Laarhoven] ]
#definition("Функтор") [ #TODO[Van Laarhoven] ]
#definition("Аппликативный функтор") [ #TODO[Почему мы отказались от Traversal, там он упоминается] ]
#definition("Редукция") [ #TODO[Я использовал слово проредуцировать где-то] ]
#definition(["Фокус"]) [ #TODO[Результат функции `get`] ]
#definition(["Умный" указатель]) [ #TODO[Swift keypath] ]
#definition("Блок-расшинерие") [ #TODO[Cangjie] ]
#definition("Область имен") [ #TODO[Где-то. Как минимум для блоков-расширений] ]
#definition("Глобальная область имен") [ #TODO[Где-то где я говорил про "засорение" области имен] ]
#definition("Функция + Метод") [ #TODO[Где-то. Как минимум для блоков-расширений] ]
#definition("Разрешение имен") [ #TODO[Где-то. Как минимум для блоков-расширений] ]
#definition("Структурный полиморфизм и deriving") [ #TODO[Кодген] ]
#definition("Первичный конструктор (Primary constructor)") [ #TODO[Кодген] ]
#definition("Сопоставление с образцом") [ #TODO[Кодген] ]
#definition("Функция интерпретации (eval)") [ #TODO[DSL] ]
#definition("Левоассоциативность") [ #TODO[DSL] ]
#definition("Свидетель типа") [ #TODO[Типобезопасность] ]

#definition([Вид "Оптики"]) [ #TODO[] ]
#definition([Модель "Оптики"]) [ #TODO[] ]
#definition([Законы "Оптики"]) [ #TODO[] ]
#definition([Интерфейс "Оптики"]) [ #TODO[] ]
...
Если бы у нас не было пользовательски операций "взять первый по условию" и все оперируемые типы были коллекциями, то @dsl наподобие `Java Stream API` было бы достаточно, однако, это не так.
