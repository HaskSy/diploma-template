...
#TODO[Переместить let-полиморфизм]
#definition("let-полиморфизм") [ возможность локально связанных переменных автоматически получать полимофные типы, позволяя одному определению специализироваться под разные контексты использования в своей области видимости.]
